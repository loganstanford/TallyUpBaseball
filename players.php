                                    ...
                                    <table id="hitters-all" class="table hitters table-striped" style="width: 1142px">
                                        ...
                                        <tbody>
                                            ...
                                            try {
                                                ...
                                                if (isset($table)) {
                                                    $sql = "SELECT player_srid as srid, player_first_name as first_name, player_last_name as last_name, team_abbr as team_name, manager_name, COALESCE(agg.pos, player_positions, 'N/A') as pos, player_status as 'Status', player_bbref as bbref_id, agg.AB, agg.R, agg.H, agg.singles, agg.doubles, agg.triples, agg.RBI, agg.SB, agg.BB, agg.HR, agg.AVG, agg.TB, agg.OBP, agg.SLG, agg.OPS, agg.BABIP, agg.Total_points, agg.bats FROM current_rosters LEFT JOIN $table as agg ON current_rosters.player_srid = agg.srid WHERE Total_points > 0 ORDER BY Total_points DESC";
                                                } else {
